...
class TestActivityManager:
    ...
    def test_get_location_types(self):
        ...
        assert activity_manager.get_location_types("House") == ['House', 'Care Home', 'Belgium',
                                                                'France', 'Germany']

        # Should return >1 item
        assert activity_manager.get_location_types("Work") == ['Care Home', 'OW Agriculture',
        'OW Extraction', 'OW Manufacturing', 'OW Energy', 'OW Water', 'OW Construction', 'OW Trade',
        'OW Transport', 'OW Catering and Accommodation', 'OW ICT', 'OW Finance', 'OW Real Estate',
        'OW Technical', 'OW Administration', 'OW Education', 'OW Entertainment',
        'OW Other Services', 'Primary School', 'Secondary School', 'Restaurant', 'Public Transport',
        'Shop', 'Medical', 'Hospital', 'Hotel', 'Place of Worship', 'Indoor Sport',
        'Cinema or Theatre', 'Museum or Zoo']

        # Should return an empty list
        assert activity_manager.get_location_types("__NULL__") == []
